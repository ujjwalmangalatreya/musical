...
import '../common_widgets/auth_failed_widget.dart';
      ...
      body: BlocBuilder<AuthBloc, AuthState>(
        builder: (context, state) {
          if (state is AuthInProgress) {
            ...
            return registrationPage(emailController,passwordController,
            confirmPasswordController,emailFormKey,passwordFormKey,
                confirmPasswordFormKey,context);
          }
        },
      ),
    );
...
Widget registrationPage(emailController,passwordController,
    confirmPasswordController,emailFormKey,passwordFormKey,
    confirmPasswordFormKey,context) {
  return SafeArea(
